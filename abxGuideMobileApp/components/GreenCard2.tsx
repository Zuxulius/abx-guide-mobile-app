                ...
                onRequestClose={() => { toggleGreenNavVisibility
                    ...
                    <ScrollView>
                        <View>
                            ...
                            ><Text style={{fontWeight: 'bold', color: 'black'}}>Samhällsförvärvad Urosepsis - Pyelonefrit - nedre afebril UVI</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                            ...
                            ><Text style={{color: 'black'}}>Urosepsis</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                            ...
                            ><Text style={{color: 'black'}}>Pyelonefrit</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                            ...
                            ><Text style={{color: 'black'}}>Akut cystit</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                            ...
                            ><Text style={{color: 'black'}}>Att tänka på</Text></Pressable>
                        </View>
                        <View>
                            <Pressable style={[styles.navScrollButton]}
                            onPress={() => {
                            ...
                            ><Text style={{fontWeight: 'bold', color: 'black'}}>Samhällsförvärvad Pneumoni</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(secondSubsection1.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Stark misstanke om pneumokockpneumoni, 'normalpatienten'</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                            ...
                            ><Text style={{color: 'black'}}>Misstanke om pneumockocker, nedsatt känslighet penicillin</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(secondSubsection3.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Misstanke om H. influenzae</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(secondSubsection4.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Misstanke om atypisk genes (ej legionella)</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(secondSubsection5.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Misstanke om Legionella</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(secondSubsection6.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Misstanke om S. aureus tex</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(secondSubsection7.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Allvarlig bakomliggande lungsjukdom vid misstanke om Pseudomonas aeruginosa</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(secondSubsection8.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Allvarlig allergi mot betalaktamantibiotika</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                        ...
                        <View>
                            ...
                            ><Text style={{fontWeight: 'bold', color: 'black'}}>Övriga samhällsförvärvade bakteriella infektioner</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(thirdSubsection1.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Erysipelas</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(thirdSubsection2.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Hud - och mjukdelsinfektion</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(thirdSubsection3.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Bukinfektion</Text></Pressable>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                                scrollIntoView(thirdSubsection4.current, options);
                                toggleGreenNavVisibility(!greenNavVisible);
                            }}
                            ><Text style={{color: 'black'}}>Infektion med oklart fokus</Text></Pressable>
                        </View>
                        <View>
                            <Pressable style={styles.navScrollButton}
                            onPress={() => {
                            ...
                            ><Text style={{fontWeight: 'bold', color: 'black'}}>Footnotes</Text></Pressable>
                        </View>
                    </ScrollView>
                </Modal>
        </ScrollView>
